<section class="ftco-about img ftco-section ftco-no-pb" id="about-section">
    <div class="container">
        <div class="row d-flex">
            ...
            <div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
              ...
              <div class="col-md-12 heading-section ftco-animate">
                ...
                <ul class="about-info mt-4 px-md-0 px-2">
                    <li class="d-flex"><span>Name:</span> <span>Shahina Akther</span></li>
                    <li class="d-flex"><span>Date of birth:</span> <span>January 18, 1990</span></li>
                    <li class="d-flex"><span>Address:</span> <span>Uttara, Dhaka, Bangladesh</span></li>
                    <li class="d-flex"><span>Zip code:</span> <span>2020</span></li>
                    <li class="d-flex"><span>Email:</span> <span>shahina@gmail.com</span></li>
                    <li class="d-flex"><span>Phone: </span> <span>01825032788</span></li>
                </ul> --}}
                <h3>Hello! I'm Shahina Akther, a passionate PHP working with Laravel.</h3>
            ...
            <p style="color: #ccc">Feel free to discuss collaborations or exciting projects!</p>
              </div>
            </div>
